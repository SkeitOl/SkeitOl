...
<section class="grid">
    ...
    <style>
        ...
        .loader::before{background:#ec7330}
        a{color: #ec7330}
        .grid__item:hover::before {border: 3px solid rgb(236, 114, 47);}
        .content__item--show .title--full{    margin: 0 0 30px;}
    ...
    <?
    $arItems=$SKEITOL->GetList("articles",["limit"=>["top"=>6],"select"=>["id",'title','date','description','author','url','src_preview','TIMESTAMP_X','views','text'],'order'=>['date'=>"desc"]]);
