...
<div class="div-hierarchy links" itemscope itemtype="http://schema.org/BreadcrumbList">
	<span itemprop="itemListElement" itemscope
      itemtype="http://schema.org/ListItem">
		<a itemprop="item" href="http://skeitol.ru" title="Главная">
...
<?/*<span itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">*/?>
	...
	if (isset($id)) {
		if($sys_pages=='programm'):?>
				<a itemprop="item" href="http://skeitol.ru/program/" title="<?=$sys_pages_print?>">
					<span itemprop="name"><?=$sys_pages_print?></span>
					<meta itemprop="position" content="2" />
				</a>
			<?else:?>
				<a itemprop="item" href="http://skeitol.ru/<?=$sys_pages?>/" title="<?=$sys_pages_print?>">
					<span itemprop="name"><?=$sys_pages_print?></span>
					<meta itemprop="position" content="2" />
				</a>
			<?endif;
