...
class ClassAdmin{
                        ...
                        <tr>
                            ...
                            <td width="90%">
                                ...
                                if(empty($myrow['src_preview'])){
                                    ...
                                    <p><label for="PREVIEW_IMAGE">URL</label> <input id="PREVIEW_IMAGE" type="text" name="src_preview" value=""></p><?
                                }
                                else
                                {
                                    ?>
  ...
  'filebrowserFlashUploadUrl':'/admin/kcfinder/upload.php?type=flash'});
                ...
                <div id="tab2" class="tab_content">
                    <p><b>meta_title<span class="help_text" title="Загаловок окна браузера">?</span>:</b><br><input type="text" name="meta_title" class="text-input"value="<?=$myrow[meta_title]?>"/></p>
                ...
                <div id="tab_sys_settings" class="tab_content">
                    <p><b>Количество просмотров:</b><br><input type="text" name="views" class="text-input" value="<?=$myrow['views']?>"/></p>
                    <p><b>Дата последнего обновления:</b><br><span class="date_TIMESTAMP_X"><?=$myrow['TIMESTAMP_X']?></span><?/*<input type="text" name="TIMESTAMP_X" class="text-input" value=""/>*/?></p>
                    ...
                    <ul id="PROP_RECOMMENDATIONS">
                        <?foreach($RECOMMENDATIONS as $value):?>
                            <li><input type="text" name="RECOMMENDATIONS[]" class="text-input" value="<?=$value?>"/></li>
                        <?endforeach;?>
                        <li><input type="text" name="RECOMMENDATIONS[]" class="text-input" value=""/></li>
                    </ul>
                        <p>
                        <span class="button add_element_prop btn " data-parent-id="PROP_RECOMMENDATIONS" data-type-parent="ul" data-add-type_block="<li>" data-add-type="<input:text>" data-add-name="RECOMMENDATIONS[]" data-add-class="text-input">Добавить</span></p>
                        <script>
                            $(function(){
                        ...
                        <style>
                            ...
                            }.btn {transition: box-shadow 0.2s cubic-bezier(0.4, 0, 0.2, 1);
